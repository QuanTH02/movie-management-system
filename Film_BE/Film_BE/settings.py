"""
Django settings for Film_BE project.
...
MIDDLEWARE = [
    ...
    "apps.core.middleware.DisableCSRFForAPI",  # Disable CSRF for API endpoints
...
WSGI_APPLICATION = "Film_BE.wsgi.application"
